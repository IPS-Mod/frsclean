...
#'
#' }
read_frs_2021_22 <- function(root = "X:/",
                             file = "HAR_PR/PR/IPS_beyond_SMI_NIHR202996/General/R/data-family-resources-survey/data/raw") {

  cat(crayon::yellow("\tReading Family Resources Survey 2021/2022:\n\n"))
  ...
  main <- data.table::fread(
    paste0(root, file, "/2021/frs2122.tab"), showProgress = FALSE,
  ...
  adult <- data.table::fread(
    paste0(root, file, "/2021/adult.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  child <- data.table::fread(
    paste0(root, file, "/2021/child.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  hhold <- data.table::fread(
    paste0(root, file, "/2021/househol.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  benunit_data <- data.table::fread(
    paste0(root, file, "/2021/benunit.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  pension_data <- data.table::fread(
    paste0(root, file, "/2021/pension.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  penprov_data <- data.table::fread(
    paste0(root, file, "/2021/penprov.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  maint_data <- data.table::fread(
    paste0(root, file, "/2021/maint.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  job_data <- data.table::fread(
    paste0(root, file, "/2021/job.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  oddjob_data <- data.table::fread(
    paste0(root, file, "/2021/oddjob.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  accounts_data <- data.table::fread(
    paste0(root, file, "/2021/accounts.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  benefits_data <- data.table::fread(
    paste0(root, file, "/2021/benefits.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
