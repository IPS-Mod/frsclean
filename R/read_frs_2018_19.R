#' Read Family Resources Survey 2018/2019
#'
#' Read in the Family Resources Survey data for the 2018-19 fiscal year.
#'
...
#'
#' }
read_frs_2018_19 <- function(root = "X:/",
                             file = "HAR_PR/PR/IPS_beyond_SMI_NIHR202996/General/R/data-family-resources-survey/data/raw") {

  cat(crayon::yellow("\tReading Family Resources Survey 2018/2019:\n\n"))
  ...
  main <- data.table::fread(
    paste0(root, file, "/2018/frs1819.tab"), showProgress = FALSE,
  ...
  adult <- data.table::fread(
    paste0(root, file, "/2018/adult.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  child <- data.table::fread(
    paste0(root, file, "/2018/child.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  hhold <- data.table::fread(
    paste0(root, file, "/2018/househol.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  benunit_data <- data.table::fread(
    paste0(root, file, "/2018/benunit.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  pension_data <- data.table::fread(
    paste0(root, file, "/2018/pension.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  penprov_data <- data.table::fread(
    paste0(root, file, "/2018/penprov.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  maint_data <- data.table::fread(
    paste0(root, file, "/2018/maint.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  job_data <- data.table::fread(
    paste0(root, file, "/2018/job.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  oddjob_data <- data.table::fread(
    paste0(root, file, "/2018/oddjob.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  benefits_data <- data.table::fread(
    paste0(root, file, "/2018/benefits.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
